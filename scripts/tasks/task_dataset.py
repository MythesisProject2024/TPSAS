...
for _ in range(nb_tasks):
    ...
    if intensive_task_counter < min_nb_of_intensive_task:
        task_size = numpy.random.randint(8000000000, 10000000000, dtype=numpy.int64)
        ...
        memoryNeed_claimed=numpy.random.randint(6000, 8000)
        ...
        task_size = numpy.random.randint(2000000000, 4000000000, dtype=numpy.int64)
