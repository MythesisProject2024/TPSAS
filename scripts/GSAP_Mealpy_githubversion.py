...
def fun_save_metrics_result(param0 = None, param1 = None, param2 = None, param3 = None, param4 = None, param5 = None ):
    ...
    csv_file_path = "GSAP_resultsDAG50.csv"
...
for run in range(num_runs):
    ...
    #------------------------------------CALL OF GSA with initial solution X
    ...
    fun_save_metrics_result("GSAP_DAG50_10MB_FitnessWithP1andP2",run, dag.name,  executionTime, best_fitness, best_solution)
...
fun_save_metrics_result("GSAP_DAG50_AverageFitnessWithP1andP2",num_runs, dag.name,  AvgExecutiontime, AvgFitness, None)
